            ...
            <div id={this.props.id} className="category row sections-projectsection">
                ...
                <Accordion id="project-themes-small">
                    ...
                    <AccordionPanel theme="machine-learning" title="Machine Learning">
                        ...
                        <div className="project">
                            <span className="bold">Clustering client segments - </span>
                        ...
                        <div className="project">
                            <span className="bold">Failing students predictor - </span>
                        ...
                        <div className="project">
                            <span className="bold">House price predictor - </span>
                    ...
                    <AccordionPanel theme="web-development" title="Web development">
                        ...
                        <div className="project">
                            <span className="bold">Personal Portfolio - </span>
                        ...
                        <div className="project">
                            <span className="bold">Disponibilidad Claro - </span>
                        ...
                        <div className="project">
                            <span className="bold">Propiedad Santiaguera - </span>
                        ...
                        <div className="project">
                            <span className="bold">5050MKT - </span>
                        ...
                        <div className="project">
                            <span className="bold">Yaque motors - </span>
                        ...
                        <div className="project">
                            <span className="bold">Herrera Checo - </span>
                        ...
                        <div className="project">
                            <span className="bold">Nexustopia (in progress) - </span>
                        ...
                        <div className="project">
                            <span className="bold">Noodle - </span>
                    ...
                    <AccordionPanel theme="mobile-development" title="Mobile Development">
                        <div className="project">
                            <span className="bold">Quizmania: Fruits - </span>
                        ...
                        <div className="project">
                            <span className="bold">Android app for restaurants (in progress) - </span>
                    ...
                    <AccordionPanel theme="desktop-and-hardware" title="Desktop and Hardware">
                      <div className="project">
                          <span className="bold">Intelligent System for Firefighters (Capstone Project in College) - </span>
                      ...
                      <div className="project">
                          <span className="bold">Online Pong Game - </span>
